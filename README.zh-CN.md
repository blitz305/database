...
一个基于 Streamlit 的图书数据探索工具，使用清洗后的 Goodreads 子集，支持交互检索、统计分析与 Open Library 信息增强。
...
不止于本地，浏览器还集成了 Open Library API 来丰富书籍信息，能够快速预览书籍内容和相关链接。界面设计简洁现代，上手极其简单，适合快速浏览和深入分析。
...
- 支持在结果表中交互选中书籍并查看详情
- 集成 Open Library API 获取更丰富的书籍信息
- 在条件查询页支持 Open Library 直搜并一键导入本地数据库
- 提供 Goodreads、豆瓣、StoryGraph 快捷链接
- 提供可视化分析页面，用于查看分布与趋势
- 提供书单管理：记录阅读状态、备注与个人评分
- 支持导出个人阅读记录为 CSV
- 支持图书目录维护：新增、编辑、删除图书并校验输入

## 基础使用

在条件查询页面中，你可以通过出版年份、评分和语言进行组合筛选，快速缩小书籍范围。

选中目标书籍后，系统会调用 Open Library API，展示封面、出版社、出版日期、分类、ISBN 与简介等信息。
